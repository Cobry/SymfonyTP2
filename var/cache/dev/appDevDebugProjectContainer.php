...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'symfonyTP2', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $d, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_45ea07eabac5daac293d7e8d9797cb6af1f6a74eec28f11cc80fba467a311452');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Purger\Advert A OC\PlatformBundle\Purger\Advert instance.
     */
    protected function getOcPlatform_Purger_AdvertService()
    {
        return $this->services['oc_platform.purger.advert'] = new \OC\PlatformBundle\Purger\Advert($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58de69b76101d0.49358834')), true);
